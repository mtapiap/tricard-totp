...
package cl.tricotcorp.financial.totp.entity.verify;
...
public class VerifyResp {
    ...
    public String toString() {
        ...
        sb.append(VerifyResp.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("codError");
        sb.append('=');
